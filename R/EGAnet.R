...
#' @importFrom stats as.dendrogram as.dist complete.cases cor cov cov2cor cutree dnorm hclust ks.test mad median na.omit p.adjust pgamma pnorm qchisq qf qgamma qnorm qt quantile rnorm runif sd setNames t.test uniroot var wilcox.test
